...
public class OthelloState implements State {
	...
	/**
	 * Returns the difference between player 1 and player 2's piece count on the edge.
	 * @return The difference between player 1 and player 2's piece count on the edge.
	 */
	private float edgeDifferential(){
		float difference = 0;
		difference += pointTable[hBoard[0] + 32768];
		difference += pointTable[hBoard[dimension-1] + 32768];
		difference += pointTable[vBoard[0] + 32768];
		difference += pointTable[vBoard[dimension-1] + 32768];
		return difference;
	}
	...
	/**
	 * Get the difference between the number of subcorners player 1 and player 2 occupy.
	 * @return The aforementioned difference.
	 */
